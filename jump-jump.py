...
on = pygame.image.load('soundOnBtn.png').convert_alpha()
off = pygame.image.load('soundOffBtn.png').convert_alpha()
...
def pause():
	...
	while paused:
		...
		draw_text('Paused',font_big, BLACK, 150, 200)
		draw_text('Press C to continue or Q to quit.',font_big, BLACK, 12, 300)
...
while run:
	...
	if start_game == False:
		...
		if game_over == False:
			...
			#update distractions
			distraction_group.update(scroll, SCREEN_WIDTH)
